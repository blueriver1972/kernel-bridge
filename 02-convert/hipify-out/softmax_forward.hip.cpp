...
int main(int argc, char **argv) {
    ...
    float* d_out;
    float* d_inp;
    cudaCheck(hipMalloc(&d_out, B * T * V * sizeof(float)));
    cudaCheck(hipMalloc(&d_inp, B * T * V * sizeof(float)));
    cudaCheck(hipMemcpy(d_inp, inp, B * T * V * sizeof(float), hipMemcpyHostToDevice));
