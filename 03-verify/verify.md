...
- [ ] **동급 하드웨어 — 미충족.** 재측정을 접었으므로 **성능 비교를 발표하지 않는다**
...
세션을 **두 번** 돌려 같은 값이 나오는지 확인했다.

| | 1회차 | 2회차 (녹화분) |
|---|---|---|
| flash max_rel_err | 1.815e-06 | **1.815e-06** |
| flash max_abs_err | 1.430e-07 | **1.430e-07** |
| flash GFLOP/s | 98.8 | **98.8** |
| 정확도 | 15/15 PASS | **15/15 PASS** |
